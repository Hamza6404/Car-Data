...
public class Playlist
{
	...
	public void printContents()
	{
		...
		for(int i = 0; i<contents.size(); i++){
			if (contents.get(i).getType() == "SONG"){
				...
				AudioBook otherBook = (AudioBook) contents.get(i);
				System.out.print(i+1 + ". ");
				otherBook.printInfo();
				System.out.println("");
			}
	...
	public void play(int index)
	{
		if (index >=1 && index<=contents.size()){
			if (contents.get(index-1).getType() == "SONG"){
				...
				AudioBook otherBook = (AudioBook) contents.get(index-1);
				otherBook.play();
		}
	}
	}
	...
	{
		Playlist otherplay = (Playlist) other;
		return this.title.equals(otherplay.title); 
